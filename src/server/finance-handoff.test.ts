...
import { financeSignature, isPrivateNetworkAddress } from './finance-handoff';
...
describe('finance handoff signing', () => {
  ...
  it('blocks loopback, private, link-local and reserved finance destinations', () => {
    for (const address of ['127.0.0.1', '10.0.0.2', '172.16.0.1', '192.168.1.1', '169.254.169.254', '100.64.0.1', '198.51.100.2', '203.0.113.5', '::1', 'fd00::1', 'fe80::1', '2001:db8::1']) {
