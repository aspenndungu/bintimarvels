  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-24 min-h-screen">
      ...
      <div className="bg-white rounded-2xl p-8 border border-brand-clay shadow-sm space-y-6 text-brand-dark-light text-sm leading-relaxed">
        <p>In accordance with the Kenya Data Protection Act, you have full control over the personal data you share with Binti Marvels Ltd.</p>
        ...
        <p>Please send all data access, correction, or deletion requests to <a href="mailto:privacy@bintimarvels.com" className="text-brand-berry font-bold hover:underline">privacy@bintimarvels.com</a>.</p>
      </div>
    </div>
  );
}
